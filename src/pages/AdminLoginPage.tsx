      ...
      <div className="max-w-md w-full p-8 bg-slate-900/90 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-800">
        ...
        {view === 'login' && (
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-sm text-slate-300 mb-1">Admin Email / ID</label>
              <input
                type="email"
                value={email}
            ...
            <div className="text-right">
              <button
                ...
                className="text-xs text-cyan-400 hover:underline focus:outline-none cursor-pointer"
              >
                Forgot Password?
              </button>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold rounded-lg shadow-lg hover:opacity-90 transition cursor-pointer"
            >
              Enter Admin Panel
            </button>
          </form>
        ...
        {view === 'forgot_email' && (
          <form onSubmit={handleVerifyEmailPhone} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-lg shadow-lg hover:opacity-90 transition cursor-pointer"
            >
              Send SMS OTP
            </button>
        ...
        {view === 'forgot_otp' && (
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-lg shadow-lg hover:opacity-90 transition cursor-pointer"
            >
              Verify OTP
            </button>
